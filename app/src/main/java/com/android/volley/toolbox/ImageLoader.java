...
//                    view.setImageResource(errorImageResId);
            ...
            public void onResponse(ImageContainer response, boolean isImmediate) {
            	String url = (String) view.getTag(R.id.tag_id);
				if (response.getRequestUrl().equals(url)){
            		 if (response.getBitmap() != null) {
//                       view.setImageBitmap(response.getBitmap());
                       if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                           view.setBackground(new BitmapDrawable(mContext.getResources(), response.getBitmap()));
                       } else {
                           view.setBackgroundDrawable(new BitmapDrawable(mContext.getResources(), response.getBitmap()));
                       }
...
//                       view.setImageResource(defaultImageResId);
     ...
     */
    public ImageContainer get(String requestUrl, ImageListener imageListener,
                              int maxWidth, int maxHeight, ScaleType scaleType, Object tag) {
