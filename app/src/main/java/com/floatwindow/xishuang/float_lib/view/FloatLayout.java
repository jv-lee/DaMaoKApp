...
/**
 * Author:xishuang Date:2017.08.01 Des:悬浮窗的布局
 */
public class FloatLayout extends FrameLayout {
	...
	public FloatLayout(Context context, AttributeSet attrs) {
		...
		mDraggableFlagView
				.setOnDraggableFlagViewListener(new DraggableFlagView.OnDraggableFlagViewListener() {
					@Override
	...
	Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			if (msg.what == 111) {
				...
				String url = "http://engine.tuicoco.com/index/image?appKey=Q4iHCZRJxk4hovWWcqGM7VP1Va4&adslotId=8478&t="
						+ i + "&deviceId=" + MainActivity._imei;
			}
		};
	};
}
