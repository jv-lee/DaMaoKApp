...
public class CoupleDragViews extends ImageView {
	...
	public CoupleDragViews(Context context, Handler mHandler) {
		super(context);
	...
	public CoupleDragViews(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		this.mContext = context;
		init();
	}

	public CoupleDragViews(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.mContext = context;
		init();
	}
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (iDeltx != 0 || iDelty != 0) {
				...
				if (right >= (screenWidth / 2 + getWidth() / 10)) {
