...
public class RectShape extends Shape {
    ...
    public RectShape(Context mContext) {
		super();
    ...
    public void draw(Canvas canvas, Paint paint) {
        canvas.drawRoundRect(mRect, DensityUtil.dip2px(mContext, 5), DensityUtil.dip2px(mContext, 5), paint);
    }

    @Override
    protected void onResize(float width, float height) {
        mRect.set(0, height*5/15 - DensityUtil.dip2px(mContext, 1), width, height*9/15);
    }
