...
/**
 * Created by akolluru on 21/08/14. A ColorPickerSeekBar is an extension of
 * SeekBar for choosing a color. The user can touch the thumb and drag left or
 * right to setUrlImage the color.
 * 
 * Clients can attach a ColorPickerSeekBar.OnColorSeekBarChangeListener to be
 * notified of color changes
 */
public class ColorPickerSeekBar extends SeekBar implements SeekBar.OnSeekBarChangeListener {
	...
	/**
	 * A callback that notifies clients when the color has been changed. This
