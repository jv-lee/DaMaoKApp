 ...
 * {@link HeaderAndFooterGridview#addHeaderView(View, Object, boolean)} See
 * {@link HeaderAndFooterGridview#addFooterView(View, Object, boolean)}
 */
public class HeaderAndFooterGridview extends GridView {
	...
	private int getNumColumnsCompatible() {
		if (Build.VERSION.SDK_INT >= 11) {
			...
			try {
				...
				throw new RuntimeException("Can not determine the mNumColumns for this API platform, please call setNumColumns to setUrlImage it.");
			}
		}
	}
	...
	public int getRowHeight() {
		...
		// adapter has not been setUrlImage or has no views in it;
			...
			public void onScrollStateChanged(AbsListView view, int scrollState) {
				...
				case OnScrollListener.SCROLL_STATE_IDLE:
					if (view.getLastVisiblePosition() == (view.getCount() - 1)) {
						if (showFootViewListener != null) {
							showFootViewListener.showFootView();
						}
					}
//					if (firstPosition == 0 && firstPosition == view.getFirstVisiblePosition()) {
						if (showHeadViewListener != null) {
							showHeadViewListener.showHeadView();
						}
//					}
					firstPosition = -1;
					break;
	...
	private class FullWidthFixedViewLayout extends FrameLayout {
		...
		@Override
		protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
			int targetWidth = HeaderAndFooterGridview.this.getMeasuredWidth() - HeaderAndFooterGridview.this.getPaddingLeft()
	...
	private ShowFootViewListener showFootViewListener;
	private ShowHeadViewListener showHeadViewListener;

	public interface ShowFootViewListener {
		void showFootView();
	}

	public interface ShowHeadViewListener {
		void showHeadView();
	}

	public void setShowFootViewListener(ShowFootViewListener listener) {
		this.showFootViewListener = listener;
	}

	public void setShowHeadViewListener(ShowHeadViewListener listener) {
		this.showHeadViewListener = listener;
	}
