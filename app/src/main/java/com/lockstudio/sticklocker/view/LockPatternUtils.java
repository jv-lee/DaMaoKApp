...
public class LockPatternUtils {
	...
	public static final long FAILED_ATTEMPT_TIMEOUT_MS = 1000 * 30;
	public static final int COLOR_BLUE = 0xff00a6e9;
	public static final int COLOR_YELLOW = 0xffeb6100;
