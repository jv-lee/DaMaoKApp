...
public class TextSettingUtils implements OnClickListener, TwoWayAbsListView.OnScrollListener  {
            ...
            switch (msg.what) {
                ...
                case 2:
                    ...
                    if (!TextUtils.isEmpty(plugin_fontPath) && new File(plugin_fontPath).exists()) {
                        onPluginSettingChange.change(plugin_fontPath, plugin_color, plugin_shadowColor);
                    }
                    break;
                case 3:
	...
	public TextSettingUtils(Context mContext) {
		this.mContext = mContext;
		view = LayoutInflater.from(mContext).inflate(R.layout.text_setting_layout, null);
	...
	public interface OnPluginSettingChange {
		public abstract void change(String fontPath, int color, int shadowColor);
	}
