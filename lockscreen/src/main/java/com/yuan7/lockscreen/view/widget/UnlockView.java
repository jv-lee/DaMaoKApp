package com.yuan7.lockscreen.view.widget;
...
public class UnlockView extends RelativeLayout {
    ...
    public UnlockView(Context mContext) {
        super(mContext);
        this.mContext = mContext;
        initView();
    }

    public UnlockView(Context mContext, AttributeSet attrs) {
    ...
    public UnlockView(Context mContext, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(TypedArray mTypedArray) {
        ...
        slideImageViewWidth = (int) mTypedArray.getDimension(R.styleable.UnlockView_slideImageViewWidth, SizeUtil.dp2px(getContext(), 50));
        slideImageViewResId = mTypedArray.getResourceId(R.styleable.UnlockView_slideImageViewResId, -1);
        slideImageViewResIdAfter = mTypedArray.getResourceId(R.styleable.UnlockView_slideImageViewResIdAfter, -1);
        viewBackgroundResId = mTypedArray.getResourceId(R.styleable.UnlockView_viewBackgroundResId, -1);
        textHint = mTypedArray.getString(R.styleable.UnlockView_textHint);
        textSize = mTypedArray.getInteger(R.styleable.UnlockView_textSize, 7);
        textColorResId = mTypedArray.getColor(R.styleable.UnlockView_textColorResId, getResources().getColor(android.R.color.white));
        THRESHOLD = mTypedArray.getFloat(R.styleable.UnlockView_slideThreshold, 0.5f);
    ...
    protected void initView() {
        ...
        LayoutInflater.from(mContext).inflate(R.layout.view_unlock,
                this, true);
        ...
        tv_hint.setTextSize(SizeUtil.sp2px(getContext(), textSize));
        ...
        rl_slide.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                DISTANCE_LIMIT = (int) (UnlockView.this.getWidth() * THRESHOLD);//默认阈值是控件宽度的一半
