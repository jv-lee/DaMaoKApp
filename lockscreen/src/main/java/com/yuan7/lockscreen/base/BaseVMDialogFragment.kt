 ...
 */
abstract class BaseVMDialogFragment<DB : ViewDataBinding, VM : ViewModel>(var layoutId: Int,var vmClass:Class<VM>) : DialogFragment(), LifecycleRegistryOwner, HasSupportFragmentInjector {
